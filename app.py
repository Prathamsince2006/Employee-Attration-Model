...
# Load the model
clf = pickle.load(open("EMP_Attration.pkl","rb"))

def predict(data):
    clf = pickle.load(open("emp_model.pkl","rb"))
...
if st.button("Predict Performance Rate"):
    ...
    st.text(result[0])
st.markdown("Developed by External Guide Avinash Pawar and WBL Intern : Prathmesh")
